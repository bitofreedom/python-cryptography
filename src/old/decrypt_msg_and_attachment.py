...
# --- CONFIGURATION ---
OUTPUT_DIR_MSG = "decrypted_message"
OUTPUT_DIR_ATT = "decrypted_attachment"
    ...
    if attachments:
        ...
        for i, att in enumerate(attachments):
            try:
                ...
                # --- Extension Logic Priority ---
                # 1. Magic Bytes (Content inspection)
                # 2. Original Filename Extension
                # 3. MimeType Guess
...
def main():
    if len(sys.argv) < 3:
        print("Usage: python3 decrypt_combined.py <input_path> <private_key.pem>")
